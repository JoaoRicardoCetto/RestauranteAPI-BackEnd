...
using RequestAuth = RestauranteAPI.Application.Security.Account.UseCases.Authenticate.Request;
using RequestChangePassword = RestauranteAPI.Application.Security.Account.UseCases.ChangePassword.Request;
using RequestRefreshToken = RestauranteAPI.Application.Security.Account.UseCases.RefreshToken.Request;
using RequestResetPasswordCode = RestauranteAPI.Application.Security.Account.UseCases.SendResetPassword.Request;
using RequestSaveRefreshToken = RestauranteAPI.Application.Security.Account.UseCases.SaveRefreshToken.Request;
using RequestToken = RestauranteAPI.Application.Security.Account.UseCases.Verify.Request;
using RequestUser = RestauranteAPI.Application.Security.Account.UseCases.Create.Request;
using ResponseAuth = RestauranteAPI.Application.Security.Account.UseCases.Authenticate.Response;
using ResponseChangePassword = RestauranteAPI.Application.Security.Account.UseCases.ChangePassword.Response;
using ResponseResetPasswordCode = RestauranteAPI.Application.Security.Account.UseCases.SendResetPassword.Response;
using ResponseSaveRefreshToken = RestauranteAPI.Application.Security.Account.UseCases.SaveRefreshToken.Response;
using ResponseUser = RestauranteAPI.Application.Security.Account.UseCases.Create.Response;
